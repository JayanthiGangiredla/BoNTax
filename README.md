...
* *   `/workflow`: The Galaxy workflow files (`BoNTax_FastA.ga` and `BoNTax_FastQ.ga`) contain the tool configurations and parameter settings used for the analyses described in this repository.
---

...
* **FASTA Workflow (`galaxytrakr-workflow/ClostBoNTax_FastA.ga`)**: Designed for assembled nucleotide sequences without quality scores.
* **FASTQ Workflow (`galaxytrakr-workflow/ClostBoNTax_FastQ.ga`)**: Designed for raw sequencing reads. Includes steps for quality control (QC) and trimming and assembly.
---
